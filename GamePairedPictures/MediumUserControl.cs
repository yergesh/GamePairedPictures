...
{
    public partial class MediumUserControl : UserControl
    {
        private MediumUserControl _instance;
        ...
        Label f, s;
        public  MediumUserControl Instance { 
            get {
                if (_instance == null)
                    _instance = new MediumUserControl();
                return _instance;
            } 
        }
        public MediumUserControl()
        {
            InitializeComponent();
